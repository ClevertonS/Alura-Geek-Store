    ...
    <section className="container-Items relative bg-black-5 px-0 pb-5">
      <div className="flex flex-col sm:flex-row sm:py-8">
        <img
          ...
          className="sm:container-Items mb-4 max-h-[340px] min-h-[192px] w-full object-cover p-0 sm:mb-0 sm:ml-8 sm:min-h-[157px] sm:min-w-[254px] sm:bg-white sm:object-contain sm:px-0 lg:max-h-[50vw] lg:min-w-[calc(50%-80px)] lg:object-cover xl:ml-[152px] xl:min-w-[calc(50%-168px)]"
        />
